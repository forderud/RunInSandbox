...
Related projects:
* Microsoft [SandboxSecurityTools](https://github.com/microsoft/SandboxSecurityTools) for testing of AppContainer Sandboxing.
* [Permission viewers](PermissionViewers.md)
