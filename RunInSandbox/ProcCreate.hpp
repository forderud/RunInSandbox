...
static ProcessHandles CreateSuspendedAppContainerProcess(AppContainerWrap& ac, const wchar_t* exe_path, const std::vector<std::wstring>& arguments) {
    ...
    ProcessInfoWrap pi;
    WIN32_CHECK(CreateProcessW(exe_path, cmdline.data(), /*proc.attr*/nullptr, /*thread attr*/nullptr, /*INHERIT_HANDLES*/FALSE, flags, /*env*/nullptr, /*cur-dir*/nullptr, (STARTUPINFO*)&si, &pi));
